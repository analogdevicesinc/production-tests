...
for n in range(5):
    ...
    # record.write("SN, Sampling Frequency, Fundamental Amplitude, Fundamental bin location, DC component, m2k_amp, m2k_offset, SNR, THD\n")
    record.write("B"+ sn + "_" + str(n+1)+ "," + str(my_adc.sampling_frequency) + "," + str(fund)+ "," + str(fund_bin) + "," + str(dc) + "," +  str(ampl) + "," + str(offset) + "," + str(snr)+ "," + str(thd)+ "\n")
    record.close()
