...
TEST_ID="01"
SHORT_DESC="USB port testing - please plug DUT_DATA in USB_DATA between Pi and DUT"
CMD="wait_enter && sleep 3 && USB_DEV=\$(iio_info -s | grep \"0456:b671\" | cut -d '[' -f 2 | cut -d ']' -f 1);"
CMD+="[ ! -z \$USB_DEV ]"
run_test $TEST_ID "$SHORT_DESC" "$CMD"

TEST_ID="02"
SHORT_DESC="USB type check - HighSpeed or SuperSpeed"
CMD="sleep 1;"
...
CMD="iio_readdev -u \$USB_DEV -b 100000 -s 50000000 axi-adrv9002-rx-lpc | pv -af >/dev/null 2>/tmp/rate;"
