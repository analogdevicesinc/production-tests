...
//  
// GMSL-D / Serializer: MAX96717 (Pixel Mode) / Mode: 1x4 / Device Address: 0x80 / Multiple-VC Case: Single VC / Pipe Sharing: Separate Pipes
// PipeZ:
// Input Stream: VC0 RGB888 PortB (D-PHY)

// Deserializer: MAX96724 / Mode: 2 (1x4) / Device Address: 0x4E
// Pipe0:
// GMSL-D Input Stream: VC0 RGB888 PortB - Output Stream: VC0 RGB888 PortB (D-PHY)

0x04,0x4E,0x04,0x0B,0x00, // BACKTOP : BACKTOP12 | CSI_OUT_EN (CSI_OUT_EN): CSI output disabled
// Link Initialization for Deserializer
0x04,0x4E,0x00,0x06,0xF8, // DEV : REG6 | LINK_EN_A (LINK_EN_A): Disabled | LINK_EN_B (LINK_EN_B): Disabled | LINK_EN_C (LINK_EN_C): Disabled | (Default) LINK_EN_D (LINK_EN_D): Enabled
0x04,0x4E,0x00,0x03,0xBF, // DEV : REG3 | DIS_REM_CC_A (GMSL Link A I2C Port 0): Disabled | DIS_REM_CC_B (GMSL Link B I2C Port 0): Disabled | DIS_REM_CC_C (GMSL Link C I2C Port 0): Disabled | (Default) DIS_REM_CC_D (GMSL Link D I2C Port 0): Enabled
...
0x04,0x80,0x00,0x02,0x03, // DEV : REG2 | (Default) VID_TX_EN_Z (VID_TX_EN_Z): Disabled
//  
...
0x04,0x4E,0x00,0xF0,0x6C, // VIDEO_PIPE_SEL : VIDEO_PIPE_SEL_0 | VIDEO_PIPE_SEL_0 (Pipe 0 GMSL2 PHY): D | VIDEO_PIPE_SEL_0 (Pipe 0 Input Pipe): X
...
0x04,0x80,0x00,0x02,0x43, // DEV : REG2 | (Default) VID_TX_EN_Z (VID_TX_EN_Z): Enabled
