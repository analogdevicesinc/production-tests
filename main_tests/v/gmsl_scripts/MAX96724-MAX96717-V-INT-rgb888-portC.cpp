...
//  
// GMSL-C / Serializer: MAX96717 (Pixel Mode) / Mode: 1x4 / Device Address: 0x80 / Multiple-VC Case: Single VC / Pipe Sharing: Separate Pipes
// PipeZ:
// Input Stream: VC0 RGB888 PortB (D-PHY)

// Deserializer: MAX96724 / Mode: 2 (1x4) / Device Address: 0x4E
// Pipe0:
// GMSL-C Input Stream: VC0 RGB888 PortB - Output Stream: VC0 RGB888 PortB (D-PHY)
...
0x04,0x4E,0x00,0xF0,0x68, // VIDEO_PIPE_SEL : VIDEO_PIPE_SEL_0 | VIDEO_PIPE_SEL_0 (Pipe 0 GMSL2 PHY): C | VIDEO_PIPE_SEL_0 (Pipe 0 Input Pipe): X
