...
// Pipe0:
// GMSL-B Input Stream: VC0 RGB888 PortB - Output Stream: VC0 RGB888 PortB (D-PHY)

0x04,0x4E,0x04,0x0B,0x00, // BACKTOP : BACKTOP12 | CSI_OUT_EN (CSI_OUT_EN): CSI output disabled
// Link Initialization for Deserializer
0x04,0x4E,0x00,0x06,0xF2, // DEV : REG6 | LINK_EN_A (LINK_EN_A): Disabled | (Default) LINK_EN_B (LINK_EN_B): Enabled | LINK_EN_C (LINK_EN_C): Disabled | LINK_EN_D (LINK_EN_D): Disabled
0x04,0x4E,0x00,0x03,0xFB, // DEV : REG3 | DIS_REM_CC_A (GMSL Link A I2C Port 0): Disabled | (Default) DIS_REM_CC_B (GMSL Link B I2C Port 0): Enabled | DIS_REM_CC_C (GMSL Link C I2C Port 0): Disabled | DIS_REM_CC_D (GMSL Link D I2C Port 0): Disabled
...
0x04,0x4E,0x00,0xF0,0x64, // VIDEO_PIPE_SEL : VIDEO_PIPE_SEL_0 | VIDEO_PIPE_SEL_0 (Pipe 0 GMSL2 PHY): B | VIDEO_PIPE_SEL_0 (Pipe 0 Input Pipe): X
