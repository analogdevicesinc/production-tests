...
0x04,0x4E,0x00,0x06,0xFE, // DEV : REG6 | LINK_EN_A (LINK_EN_A): Disabled | (Default) LINK_EN_B (LINK_EN_B): Enabled | LINK_EN_C (LINK_EN_C): Enabled | LINK_EN_D (LINK_EN_D): Enabled
