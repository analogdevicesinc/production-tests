...
echo_blue "Connect the cameras on port 2. Press ENTER when done."
wait_enter
...
TEST_ID="03"
SHORT_DESC="Configuring GMSL port 2"
CMD='ssh_cmd "sudo /home/analog/Workspace/config_streaming_v2/media_cfg_des12_v2_ov5640_p2.sh"'
run_test $TEST_ID "$SHORT_DESC" "$CMD"
